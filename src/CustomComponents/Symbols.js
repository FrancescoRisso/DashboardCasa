/*
 ...
 description:
 	A collection of svg symbols to show the weather
			...
			<div className="d-none">
				<svg>
					...
					<symbol id="svg-symbol-hail" viewBox="0 0 89 170">
						<path
							d="M24,2 L9,37 L24,2 Z M10,5 L2,23 L10,5 Z"
							stroke="var(--color-hail)"
							strokeWidth="4"
							strokeLinecap="round"
					...
					<symbol id="svg-symbol-sun-ray">
						<path d="M100,44.1c3.1,0,6.1,0.3,9,0.7l-5.3-40.7c0,0,0-0.1,0-0.1c-0.3-1.9-2-3.2-4-3c-1.5,0.2-2.7,1.3-3,2.8 c0,0.1-0.1,0.2-0.1,0.2l-5.5,40.7C94.1,44.3,97,44.1,100,44.1z"></path>
					</symbol>
					<symbol id="svg-symbol-sun" fill="var(--color-sun)">
						<use xlinkHref="#svg-symbol-sun-ray"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(30, 100, 100)"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(60, 100, 100)"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(90, 100, 100)"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(120, 100, 100)"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(150, 100, 100)"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(180, 100, 100)"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(210, 100, 100)"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(240, 100, 100)"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(270, 100, 100)"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(300, 100, 100)"></use>
						<use xlinkHref="#svg-symbol-sun-ray" transform="rotate(330, 100, 100)"></use>
					...
					>
						<use xlinkHref="#svg-symbol-snowflake-branch" transform="rotate(0 100 100)"></use>
						<use xlinkHref="#svg-symbol-snowflake-branch" transform="rotate(60 100 100)"></use>
						<use xlinkHref="#svg-symbol-snowflake-branch" transform="rotate(120 100 100)"></use>
						<use xlinkHref="#svg-symbol-snowflake-branch" transform="rotate(180 100 100)"></use>
						<use xlinkHref="#svg-symbol-snowflake-branch" transform="rotate(240 100 100)"></use>
						<use xlinkHref="#svg-symbol-snowflake-branch" transform="rotate(300 100 100)"></use>
					</symbol>
					...
					<symbol id="svg-symbol-icy" viewBox="0 0 8.9 10.9">
						<path d="M8.9 1.1L8.1 8c0 .1-.1.2-.2.2s-.2-.1-.2-.2l-.6-4.7-1 7.4c0 .1-.1.2-.2.2s-.3-.1-.3-.2L4.6 3l-.4 3.3c0 .1-.1.1-.1.1-.1 0-.2 0-.2-.1l-.3-2.8-.8 5.6c0 .1-.1.2-.2.2s-.2-.1-.2-.2l-.7-5.2-.4 3.4c0 .1-.1.2-.2.2s-.2-.1-.2-.2L0 1V.9C0 .7 0 .6.1.4.2.1.5 0 .8 0h7.3c.3 0 .5.2.7.4.1.1.1.3.1.5v.2z"></path>
					</symbol>
				</svg>
			</div>
		);
